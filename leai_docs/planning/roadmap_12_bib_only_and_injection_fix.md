...
- [ ] Story 12.1: Backend Router Boundary Marshal (.bib Restriction) | [MoSCoW: MUST] | [Complexity: EASY] (<-- REQ-036)
...
- [ ] Story 12.2: Backend Parser Core Logic (.bib Extraction) | [MoSCoW: MUST] | [Complexity: MEDIUM] (<-- REQ-038)
